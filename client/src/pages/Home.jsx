...
export default function Home() {
  ...
  return (
    ...
    <div className='relative flex flex-col'>
      ...
      {/* top ends here  */}
      <Footer.Divider/>
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl text-right mx-auto mt-0'>
          <Link to={'/about'}>
          <h1 className='md:text-4xl sm:text-base hover:underline font-bold custom-font-color1'>من نحن؟</h1>
          </Link>
      ...
      <div className='flex flex-col gap-6 p-28 px-3 max-w-6xl text-right mx-auto mt-0'>
          ...
          <p id='arabic' className='mt-6 mb-6 text-lg font-bold custom-font-color3 text-right'>نفذت مجموعة الروافد العقارية مجموعة متنوعة من المشاريع الكبرى التي تغطي مجالات متعددة في قطاع العقارات والبناء. تشمل مشاريعنا السكنية والتجارية، باستخدام أحدث التقنيات والابتكارات لضمان الجودة والاستدامة. تميزنا بإدارة وتنفيذ مشاريع ضخمة بدقة واحترافية، مما يعزز من مكانتنا كشركة رائدة في السوق السعودي. نعمل على تحقيق أعلى مستويات الرضا لعملائنا من خلال تقديم حلول مبتكرة تلبي احتياجاتهم وتساهم في تطوير البنية التحتية بما يتماشى مع رؤية المملكة 2030..
          </p>
