      ...
      <Slide>
        ...
        <div id='arabic' className='flex flex-col mt-16 mb-16 '>
          ...
          <div>
            ...
            <p className='mt-3 mb-3 mr-3 ml-3 text-xl custom-font-color3'>تقدم مجموعة الروافد التجارية مجموعة شاملة من الخدمات المتكاملة التي تلبي احتياجات السوق العقاري في المملكة العربية السعودية. تتميز خدماتنا بالاحترافية والجودة العالية، مما يجعلنا الخيار الأمثل لعملائنا. تشمل خدماتنا</p>
          </div>
